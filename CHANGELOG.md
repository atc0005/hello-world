...
Please [open an issue](https://github.com/atc0005/hello-world/issues) for any
...
| --------- | -------------- | --------------------------------------------------- |
| `hw`      | Alpha          | Small CLI tool for decoding a given Safe Links URL. |

See the project README for additional details.

[Unreleased]: https://github.com/atc0005/hello-world/compare/v0.2.1...HEAD
[v0.2.1]: https://github.com/atc0005/hello-world/releases/tag/v0.2.1
[v0.2.0]: https://github.com/atc0005/hello-world/releases/tag/v0.2.0
[v0.1.1]: https://github.com/atc0005/hello-world/releases/tag/v0.1.1
[v0.1.0]: https://github.com/atc0005/hello-world/releases/tag/v0.1.0
